		      ...
		      <div class="row">
		        <div class="input-field col l5 s6">
		        	<span class="light">Name:</span>
		      		<input required placeholder="Name of Candidate" id="reg_number" type="text" class="validate" name="name" maxlength="50">
		        </div>
		       ...
		       <div class="row">
		        <div class="input-field col l5">      		  
		         ...
		         <textarea required id="textarea1" class="materialize-textarea" name="permanent_addr" maxlength="200"></textarea>
		            ...
		            <p>Landline Number:</p>
		            <input required type="number" min="7000000000" max="9999999999" class="validate" name="landline"></input>
		        </div>
		      </div> 
