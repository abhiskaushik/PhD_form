...
class CreateSavePhd extends Migration
{
    ...
    public function up()
    {
        Schema::create('savedphd', function (Blueprint $table) {
            ...
            $table->string('category', 5)->default('');
            $table->string('sex', 10)->default('');
            $table->string('maritalStatus', 10)->default('');
            $table->string('PH', 5)->default('');
            ...
            $table->bigInteger('lanline')->default(0);
            ...
            $table->string('ugclass', 10)->default('');
            ...
            $table->string('pgclass', 10)->default('');
